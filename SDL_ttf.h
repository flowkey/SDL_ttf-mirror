...
extern DECLSPEC SDL_Surface * SDLCALL TTF_RenderAttributedUTF8_Blended(TTF_Font *font, const char *text, SDL_Color *foregroundColorForCharacter);
...
extern DECLSPEC int Find_Glyph(TTF_Font* font, Uint32 ch, int want);
